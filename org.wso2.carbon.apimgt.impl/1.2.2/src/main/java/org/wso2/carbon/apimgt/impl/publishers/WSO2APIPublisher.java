...
public class WSO2APIPublisher implements APIPublisher {
    ...
    private List<NameValuePair> getParamsList(API api,String externalPublisher, String action) throws APIManagementException{
        // Request parameters and other properties.
        ...
        params.add(new BasicNameValuePair("redirectURL", getExternalStoreRedirectURL()));
    ...
    private String getExternalStoreRedirectURL() throws APIManagementException {
    	 Registry registry;
